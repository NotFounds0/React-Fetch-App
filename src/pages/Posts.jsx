...
const Posts = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Posts & Comments</h1>
      <Search onSearch={handleSearch} placeholder="Search posts..." />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentPosts.map(post => (
          <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden cursor-pointer transition duration-300 ease-in-out transform hover:scale-105" onClick={() => handlePostSelect(post.id)}>
            <div className="p-6">
      ...
      {selectedPost && (
        <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
          ...
          <h3 className="text-xl font-semibold mb-4 text-gray-800">Comments ({selectedPost.comments.length})</h3>
